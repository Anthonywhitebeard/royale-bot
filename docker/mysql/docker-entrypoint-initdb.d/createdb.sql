...
CREATE DATABASE IF NOT EXISTS `royale` COLLATE 'utf8_general_ci' ;
GRANT ALL ON `royale`.* TO 'royale'@'%' ;

CREATE DATABASE IF NOT EXISTS `royale_test` COLLATE 'utf8_general_ci' ;
GRANT ALL ON `royale_test`.* TO 'royale'@'%' ;
