...
return [
    ...
    'operations' => [
        ...
        [
            ...
            'target' => '1',
            'params' => '%turnAlivePlayers.1.name% с криками "Что ты сказал про мою маму?" напал на %turnAlivePlayers.2.name%. Спустя пару смачных тумаков, %turnAlivePlayers.1.name% понял, что его обманули и извинившись, отступил. %turnAlivePlayers.0.name% удивленный настолько хорошо сработавшей провокации, попытался вспомнить какую-то цитату из Исскусства Войны по этому поводу, но не преуспел в этом',
        ],
    ],
    'conditions' => [
