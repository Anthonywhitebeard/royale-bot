...
return [
    ...
    'operations' => [
        ...
        [
            ...
            'target' => '1',
            'params' => '%turnAlivePlayers.0.name% незаметно подойдя к противнику, начинает нещадно лупить его волшебной книгой. Со криками "Это не так работает немножко" %turnAlivePlayers.1.name% сбежал от поехавшего'
        ],
    ],
    'conditions' => [
        "warlock_class",
