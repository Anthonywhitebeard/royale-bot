...
return [
    ...
    'operations' => [
        ...
        [
            ...
            'target' => '0',
            'params' => '%turnAlivePlayers.0.name% направил посох на %turnAlivePlayers.1.name% и с устрашающим видом начал читать проклятие. Не дожидаясь чем это может закончиться, %turnAlivePlayers.1.name% просто атаковал неудачного чернокнижника'
        ],
    ],
    'conditions' => [
        "warlock_class",
